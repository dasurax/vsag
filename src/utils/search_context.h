...
class SearchContext : public ResourceObject {
public:
    using VisitedListType = uint16_t;

public:
    explicit SearchContext(InnerIdType max_size, Allocator* allocator)
...
using VisitedListPool = ResourceObjectPool<SearchContext>;
using VisitedListPtr = std::shared_ptr<SearchContext>;
